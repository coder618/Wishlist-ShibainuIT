            ...
            <table class="form-table" role="presentation">
                <tbody>
                    <tr>
                        ...
                        <td><input name="sit_before_add_html" type="text" id="sit_before_add_html" value="<?php echo get_option( SIT_BEFORE_ADDED_BTN_HTML ) ?>" class="regular-text"></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="sit_after_add_html">After adding product button text/html</label></th>
                        <td><input name="sit_after_add_html" type="text" id="sit_after_add_html" value="<?php echo get_option( SIT_AFTER_ADDED_BTN_HTML ) ?>" class="regular-text"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; flex-direction:column ">
                                <label style="margin-bottom: 10px"><input name="sit_default_btn_visibility" type="radio" value="visible" <?php echo $sit_default_btn_visibility == 'visible' ? 'checked="checked"' : ''?> >Visible</label>
                                <label><input name="sit_default_btn_visibility" type="radio" value="hidden" <?php echo $sit_default_btn_visibility == 'hidden' ? 'checked="checked"' : ''?> >Hidden</label>
